...
$string['save_successmessage'] = 'Your Town Square settings have been saved.';
...
$string['townsquare:addinstance'] = 'Add the Town Square block';
$string['townsquare:myaddinstance'] = 'Add the Town Square block to the dashboard';
